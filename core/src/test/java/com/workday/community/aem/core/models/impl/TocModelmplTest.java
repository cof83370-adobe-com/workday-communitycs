...
public class TocModelmplTest {
  ...
  public void setup() throws Exception {
    ...
    context.load()
        .json("/com/workday/community/aem/core/models/impl/TocModelImplTest.json", "/content");
  }
  ...
  void testBookResourcePath() throws Exception {
    ...
    lenient().when(queryService.getBookNodesByPath(currentPage.getPath(), null))
        .thenReturn(pathList);
    context.registerService(Page.class, currentPage);
    TocModel tocModel = context.request().adaptTo(TocModel.class);
    assertEquals("/content/book-1/jcr:content/root/container/container/book",
        tocModel.bookResourcePath());
  }
