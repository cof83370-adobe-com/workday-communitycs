...
public class TaxonomyModelTest {
  ...
  public void setup() throws Exception {
    context.load()
        .json("/com/workday/community/aem/core/models/impl/TaxonomyModelTest.json", "/content");
  ...
  public void testInit() throws AccessControlException, InvalidTagFormatException {
    ...
    tm.createTag("programs-and-tools:program-type/the-next-level", "The Next Level",
        "the next level");
    ...
    tm.createTag("using-workday:workday-acquisition-integrations",
    ...
    List<String> expectedProductTagsList =
        Arrays.asList("Analytics & Reporting", "Connection to Workday Financial Management"
        );
    List<String> expectedReleaseTagsList =
        Arrays.asList("Workday 10 - Retired", "Workday 11 - Retired"
        );
    List<String> expectedUsingWorkdayTagsList =
        Arrays.asList("Content Management", "Workday Acquisition Integrations"
        );
   ...
   */
  @Test
  public void testWithProgramTypeTagsEmpty()
