...
public class TaxonomyBadgeImplTest {
  ...
  public void setup() throws Exception {
    context.load()
        .json("/com/workday/community/aem/core/models/impl/TaxonomyBadgeImplTest.json", "/content");
   ...
   */
  @Test
  public void testReleaseNotesTaxonomyBadges()
   ...
   */
  @Test
  public void testTrainingCatalogTaxonomyBadges()
      throws AccessControlException, InvalidTagFormatException {
    Page currentPage =
        context.currentResource("/content/training-catalog-page").adaptTo(Page.class);
    context.registerService(Page.class, currentPage);
    final List<String> expectedBadges =
        Arrays.asList("Learn On Demand", "Learn Virtual", "Workday Pro",
            "Refresher Training");
    TaxonomyBadge taxonomyBadge = context.request().adaptTo(TaxonomyBadge.class);
    List<String> actualBadges = taxonomyBadge.getBadgeList();
    assertEquals(expectedBadges, actualBadges);
   ...
   */
  @Test
  public void testUnsuportedTemplateType()
      throws AccessControlException, InvalidTagFormatException {
  ...
  private void populateTagManager(TagManager tagManager) {
    try {
      ...
      tagManager.createTag("event:event-format/webinar/customer-spotlight", "Customer Spotlight",
          "test tag");
      ...
      tagManager.createTag("release-notes:change-type/what-s-coming-next", "What's Coming Next",
          "test tag");
      ...
      tagManager.createTag("release-notes:change-type/alert/product-defect", "Product Defect",
          "test tag");
      tagManager.createTag("training:/training-format/learn-on-demand", "Learn On Demand",
          "test tag");
      tagManager.createTag("training:/training-format/learn-independent", "Learn Independent",
          "test tag");
      tagManager.createTag("training:/training-format/learn-in-person", "Learn In Person",
          "test tag");
      tagManager.createTag("training:/training-format/learn-virtual", "Learn Virtual", "test tag");
      tagManager.createTag("training:/training-format/refresher-training", "Refresher Training",
          "test tag");
