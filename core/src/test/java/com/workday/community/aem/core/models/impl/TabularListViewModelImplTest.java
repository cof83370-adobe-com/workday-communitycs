...
public class TabularListViewModelImplTest {
    ...
    public void setUp() {
        ...
        mockDamUtils.when(() -> DamUtils.readJsonFromDam(eq(resourceResolver), eq("/content/dam/workday-community/resources/tab-list-criteria-data.json")))
                .thenReturn(modelConfig);
    }

    @Test
    void testComponent() throws RepositoryException, DamException {
        TabularListViewModel tabListViewModel = context.currentResource("/component/tabularListView").adaptTo(TabularListViewModel.class);
        ...
        mockDamUtils.when(() -> DamUtils.readJsonFromDam(eq(mockResourceResolver), eq("/content/dam/workday-community/resources/tab-list-criteria-data.json")))
              .thenReturn(modelConfig);
