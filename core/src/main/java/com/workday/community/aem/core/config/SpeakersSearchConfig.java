...
public @interface SpeakersSearchConfig {
  ...
  @AttributeDefinition(name = "Speakers Search field look up Api Consumer Key", description = "Speakers Search field look up Api Consumer Key")
  String searchFieldConsumerKey() default "r4hd9dxB9ToJWYBQpJAhUauGXoh4r35r";

  @AttributeDefinition(name = "Speakers Search field look up Api Consumer Secret", description = "Speakers Search field look up Api Consumer Secret")
