package com.workday.community.aem.migration.servlets;
...
public class XMLDataImporterServlet extends SlingSafeMethodsServlet {
	...
	protected void doGet(final SlingHttpServletRequest req, final SlingHttpServletResponse resp)
		...
		try(ResourceResolver resolver = req.getResourceResolver()) {
			final String sourceFile = req.getParameter(MigrationConstants.SOURC_FILE_PARAM);
			final String template = req.getParameter(MigrationConstants.TEMPLATE_PARAM);
